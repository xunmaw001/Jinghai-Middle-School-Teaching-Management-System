                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="kaoshiName" name="kaoshiName" class="form-control"
                                               placeholder="考试标题" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>考试学科</label>
                                        <input id="xuekeValue" name="xuekeValue" class="form-control"
                                               placeholder="考试学科" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>考试时间</label>
...
<script>
    ...
    function kaoshiDataBind(){
        ...
        $("#xuekeValue").val(ruleForm.xuekeValue);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
        if(window.sessionStorage.getItem('addchengji') != null && window.sessionStorage.getItem('addchengji') !=""){//新增查询,修改不查
            // 查询当前登录账户的信息
            var userId = window.sessionStorage.getItem('userId');
